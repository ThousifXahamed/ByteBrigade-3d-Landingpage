      ...
      >
        <div className="w-full h-2/4 md:h-full md:w-2/5 flex flex-col justify-center items-center md:items-start gap-8">
          <div className="flex flex-col gap-2">
            <h1 className="text-4xl font-black md:text-8xl">Byte Brigade</h1>
            <h2 className="text-md md:text-2xl">Start growing today!</h2>
          </div>
          <p className="max-w-md text-sm md:text-base text-gray-400">
            Byte Brigade is a community-driven coding club dedicated to
            empowering aspiring developers with the skills and resources they
            need to succeed.
          </p>
          <div className="w-full flex items-center justify-center md:justify-start gap-4">
            <button className="w-48 h-12 text-sm sm:text-base rounded bg-fuchsia-700 text-white hover:bg-white hover:text-fuchsia-700 transition-colors">
              Join Us
            </button>
            <button className="w-48 h-12 text-sm sm:text-base rounded bg-transparent text-white border border-white hover:bg-white hover:text-fuchsia-700 hover:border-fuchsia-700 transition-colors">
              Contact Us
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div className="w-full h-full flex items-center justify-center flex-col gap-8 max-w-7xl">
          <h3 className="text-4xl md:text-5xl font-bold text-gray-400">
            Byte Brigade: Empowering Coders
          </h3>
  ...
  return (
    <div className="w-full h-16 backdrop-filter backdrop-blur-xl bg-opacity-20 border-b flex items-center justify-center">
      <div className="max-w-7xl w-full flex items-center justify-between p-4">
        <h6 className="font-bold">Byte Brigade</h6>
